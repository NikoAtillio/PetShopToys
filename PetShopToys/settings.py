...
SECRET_KEY = 'django-insecure-v0yn7av$!b(34y%o$^a7yc-3-*cqh*y5%o=klu_*m2b@^us#wq'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'payment.context_processors.cart_items_count',
            ],
        },
    }
]

WSGI_APPLICATION = 'PetShopToys.wsgi.application'
